...
<head>
  ...
  <style>
    ...
    .hero{
      ...
      url('https://images.unsplash.com/photo-1527838832700-5059252407fa?q=80&w=2070&auto=format&fit=crop');
    ...
    .btn-tr{
      background: linear-gradient(45deg,#E30A17,#ffffff);
      color: #000;
      font-weight: bold;
      border: none;
      padding: 12px 30px;
...
<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container">
    <a class="navbar-brand fw-bold" href="#">🇹🇷 TURQUIE</a>
...
<section class="hero">
  <div class="container">
    ...
    <p>Entre l’Europe et l’Asie, un pays riche en histoire et culture</p>
    <a href="#about" class="btn btn-tr mt-4">Découvrir</a>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-left">
        ...
        <h3 class="fw-bold">République de Turquie</h3>
...
<section id="histoire" class="bg-white">
  <div class="container">
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6" data-aos="fade-right">
        <img src="https://images.unsplash.com/photo-1541439242575-ef0e13b1b6c6?q=80&w=2070&auto=format&fit=crop"
      ...
      <div class="col-lg-6" data-aos="fade-left">
        ...
        <p>
          ...
          En 1923, Mustafa Kemal Atatürk fonde la République moderne de Turquie.
        </p>
...
<footer>
  <h5>🇹🇷 Turquie</h5>
  <p>Site éducatif avec Bootstrap & animations</p>
</footer>
